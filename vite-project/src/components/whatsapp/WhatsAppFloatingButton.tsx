...
// Configura aquí tu número de teléfono (código de país + número, sin espacios ni símbolos)
// Ejemplo: 5493511234567
const PHONE_NUMBER = "5492995238850";

// Mensaje predeterminado (opcional)
const DEFAULT_MESSAGE = 'Hola, estoy interesado en los servicios de SupraSense.';
...
export const WhatsAppFloatingButton: React.FC = () => {
    ...
    return (
        ...
        "
            >
                Conversemos!
                {/* Triángulo del tooltip apuntando al botón */}
                <div
                    className="
            absolute 
            top-1/2 
